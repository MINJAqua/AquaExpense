...
import { usePlaidLink,
  ...
  PlaidLinkOnEvent,
  PlaidLinkOnExit,
  PlaidLinkOptions, } from 'react-plaid-link';

  //use these varibles when making an axios request to avoid long url
  const transactionsEndpoint = 'http://localhost:8000/api/create_link_token/transactions/get';
  const accessTokenEndpoint =  'http://localhost:8000/api/create_link_token/items/public_token/exchange';
